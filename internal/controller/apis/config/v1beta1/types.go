...
import (
	genericconfigv1beta1 "github.com/fleezesd/xnightwatch/pkg/config/v1beta1"
...
const (
	// XControllerManagerDefaultLockObjectNamespace defines default x-controller manager lock object namespace ("kube-system").
	XControllerManagerDefaultLockObjectNamespace string = metav1.NamespaceSystem

	// XControllerManagerDefaultLockObjectName defines default x-controller manager lock object name ("x-controller-manager").
	XControllerManagerDefaultLockObjectName = "onex-controller-manager"
)

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// XControllerManagerConfiguration contains elements describing x-controller manager.
